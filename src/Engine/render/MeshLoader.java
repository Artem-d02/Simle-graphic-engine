...
public class MeshLoader {
    private static List<Integer> vaos = new ArrayList<Integer>();   //  vertex array objects list
    private static List<Integer> vbos = new ArrayList<Integer>();   //  vertex buffer objects list
